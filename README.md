...
We use cv2 - opencv, numpy, cupy and ffmpeg-python currently
...
on the checkerboard used for calibration and allowed pins whihc allows the script to go through all the cameras and pairs of cameras basd on te sequence

cameraCalibration.py
this script takes as input the images recorded using the script above and runs internal routines to optimize intrisic and extrinisc parameters for each camera 

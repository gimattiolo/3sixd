<Dev environment>
We used UV (https://docs.astral.sh/uv/) for creating python enviroment to run the script with their dependencies. You should use it to easily setup the environment for running th scripts. 
